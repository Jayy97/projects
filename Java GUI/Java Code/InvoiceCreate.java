...
/**
 * 
 * A class representing a GUI for creating a new invoice.
 */
public class InvoiceCreate extends JFrame implements ActionListener {
    ...
    /**
     * 
     * The text field for the product amount.
     */
    private JTextField customerIdField, productIdField, productAmountField;

    /**
     * 
     * Constructs an InvoiceCreate object with a specified title, default close

...
/**
 * 
 * A class representing the GUI window for retrieving a product from the
 * inventory
 */
public class ProductRetrieve extends JFrame implements ActionListener {
    /**
     * 
     * Constructs a new ProductRetrieve object
     * 
     * Sets the title, size and close operation of the GUI window
     * 
     * Initializes and adds GUI components to the window
     */
